...
class NewDepenseScreen extends StatefulWidget {
  final String currency;

  const NewDepenseScreen({super.key, required this.currency});

  @override
  State<NewDepenseScreen> createState() => _NewDepenseScreenState();
}

class _NewDepenseScreenState extends State<NewDepenseScreen> {
  ...
  Future<void> _loadFormData() async {
    try {
      ...
      if (!mounted) return;
      final categories = results[0] as List<CategorieDepense>;
  ...
  Future<void> _submit() async {
    ...
    if (_selectedCategoryId == null) {
      _showError('Choisissez une categorie');
      return;
    }
    if (_selectedCompteId == null) {
      _showError('Creez d\'abord un compte pour enregistrer une depense');
      return;
    }
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: _fieldDecoration(
                        hint: 'Ex. Courses, loyer...',
                        icon: Icons.label_outline_rounded,
                      ),
                      validator: (v) {
                        if (v == null || v.trim().isEmpty) {
                          return 'Decrivez la depense';
                        }
                        return null;
                      },
                    ),
                    ...
                    _comptes.isEmpty
                        ? Container(
                            ...
                            child: const Text(
                              'Aucun compte disponible. Creez un compte avant d\'ajouter une depense.',
